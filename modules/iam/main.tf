...
resource "aws_iam_role_policy_attachment" "eks_node_ssm_managed_instance" {
  role       = aws_iam_role.eks_node_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}

# EKS Node Group S3 Policy
...
resource "aws_iam_role_policy_attachment" "eks_node_s3_policy_attachment" {
  role       = aws_iam_role.eks_node_role.name
  policy_arn = aws_iam_policy.eks_node_s3_policy.arn
}

# Load Balancer Controller Policy (for AWS Load Balancer Controller)
